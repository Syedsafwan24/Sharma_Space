...
const TopNavbar = () => {
	...
	return (
		<div
			className={`fixed top-0 left-0 right-0 bg-white p-4 flex items-center justify-between shadow-md lg:hidden z-40 transition-transform duration-300 ${
		...
		>
			...
			<div className='flex items-center gap-4'>
				<Link
					href='/admin/messages'
					className='text-gray-600 hover:text-[#E63946]'
				>
					<Mail size={24} />
				</Link>
				<button
